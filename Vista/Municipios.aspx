...
<div class="container">
  <div class="row">
    <div class="column-66">
  <asp:Label ID="lblNombre" runat="server" Text="Label" class="large-font" style="color:MediumSeaGreen;" ></asp:Label>
        <br />
        <br />
        <asp:Label ID="lbldescripcion" runat="server" Text="Label"  style="color:black"></asp:Label>
...
<div class="container" style="background-color:#f1f1f1">
  <div class="row">
    <div class="column-33">
      <img src="https://th.bing.com/th/id/OIP.2ITffA2aglWzdWctmiXggAHaE7?pid=ImgDet&rs=1" alt="App" width="335" height="471"/>
    </div>
    <div class="column-66">
      ...
      <div class="container" style="margin-top: 20px;">
        ...
        <!-- Agrega más divs con la clase "card" para más cards -->
