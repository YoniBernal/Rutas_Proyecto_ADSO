<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SitioWebRutas.Vista.Login" %>
...
<%--            <input id="user" type="text" class="input">--%>
        ...
        <div class="group">
          ...
          <asp:TextBox ID="txtcontra"  type="text" class="input"   runat="server"></asp:TextBox>
        ...
        <div class="hr">
          ...
          <asp:Button ID="Sesion" CssClass="btn btn-primary" runat="server" Text="Ingresar" OnClick="Sesion_Click" />
        </div>
        <div class="foot-lnk">
        </div>
      </div>
